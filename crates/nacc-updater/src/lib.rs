//! Signed update coordination for the Tauri updater.
//!
//! Master plan S13.7 -- Phase 12 scope for real signing/verification; the Phase 1 dev keypair itself lives in src-tauri/tauri.conf.json. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = UpdaterError::Other("boundary established".into());
