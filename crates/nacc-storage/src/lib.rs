...
//!
//! Master plan S16 -- Phase 2 scope for real schema and migrations. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = StorageError::Other("boundary established".into());
