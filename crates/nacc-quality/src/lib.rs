//! Deterministic quality-gate execution: formatter, lint, typecheck, test, build, packaging commands.
//!
//! Master plan S20 -- Phase 9 scope for real gate execution. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = QualityError::Other("boundary established".into());
