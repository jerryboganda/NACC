//! Typed Git operations invoked via the installed git CLI with argument arrays, never interpolated shell strings.
//!
//! Master plan S4.5 -- Phase 3 scope for real git invocation. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = GitError::Other("boundary established".into());
