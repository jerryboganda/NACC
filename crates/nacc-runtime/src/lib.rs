//! Native Windows / WSL2 / Docker runtime abstraction.
//!
//! Master plan S10 -- Phase 3 scope for the real abstraction. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = RuntimeError::Other("boundary established".into());
