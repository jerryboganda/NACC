//! Review findings, diff annotations, and dispositions for the Review Center.
//!
//! Master plan S17.10 -- Phase 9 scope for real review logic. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = ReviewError::Other("boundary established".into());
