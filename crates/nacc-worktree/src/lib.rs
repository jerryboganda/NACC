//! Git worktree lease lifecycle: allocation, drift detection, quarantine, safe cleanup.
//!
//! Master plan S11, S16 -- Phase 3 scope for real lease management. This crate establishes the workspace boundary and
...
mod tests {
    ...
    fn error_displays_its_message() {
        let err = WorktreeError::Other("boundary established".into());
